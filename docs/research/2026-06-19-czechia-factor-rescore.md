...
**Scope:** Sixth country re-scored under the factor model. All 15 categories, 82 factors, scored 0–100 against `categories.json`; derived in `scoring.ts`. Czechia was a full `pending` placeholder.
