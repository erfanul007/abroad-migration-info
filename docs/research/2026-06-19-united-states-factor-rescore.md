...
**Scope:** 20th and final country under the factor model. 15 categories, 82 factors vs `categories.json`; derived in `scoring.ts`. US was a full `pending` placeholder.
