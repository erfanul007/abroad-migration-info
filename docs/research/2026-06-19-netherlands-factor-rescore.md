...
**Scope:** 14th country under the factor model. 15 categories, 82 factors vs `categories.json`; derived in `scoring.ts`. Netherlands was a full `pending` placeholder.
