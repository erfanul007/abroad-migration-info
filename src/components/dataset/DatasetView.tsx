...
/** The tabbed body of one supplementary dataset: a sortable/searchable table, plus optional
 *  compare, methodology, and sources/caveats tabs. Rendered inside a country dataset page. */
